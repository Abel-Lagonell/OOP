/**
 * Title                3D points with inheritance
 * Author               Abel Lagonell
 * Email:               alagonell@floridapoly.edu
 * Version:             0.0.1a
 * Creation date:       2022-11-22 11:18:18
 * Modification Date:   2022-11-22 13:12:52
 * Description:         Make 3D points of inheritance with 2D points
*/
...
public:
    ...
    ThreeDPoint(double x, double y, double z) {setx(x); sety(y); this->z=z;}
