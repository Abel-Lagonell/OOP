...
TDP::TwoDayPackage(const string &name, const string &address, const string &city, const string &state, int zipCode, double weight, double costPerOunce, double flatfee) : Package(name,address, city, state,zipCode, weight, costPerOunce){
    setFlatFee(flatfee);
}
